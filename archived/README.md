...
This is an old libpcap-py project I’m keeping around for reference.  
It’s likely broken.

In the last 3 years I learned a lot and Python tooling changed a ton.  
This version was basically a flat C-API wrapper with no DevOps/packaging setup.

The current libpcap-py now has things like:
- `src/` layout
- `pyproject.toml`
- better license fit (used to be BSD-2-Clause)
- `uv`, devshell, `justfile`, etc.

Fun fact: I used an Org file to track supported-function percentages.
